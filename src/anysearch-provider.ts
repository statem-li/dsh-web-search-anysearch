 ...
 *
 * Ported verbatim from `statem-li/dsh-webui` `src/provider.ts` (module
 * `dsh-web-search-anysearch/provider`), with the single runtime difference
 * that `WebError` comes from `./vendor/error.ts` instead of `@deepseek-ai/dsh-web`
 * (see the vendor header for why).
...
import { WebError } from './vendor/error.ts'
