/**
 * Shared form model behind every plugin card — verbatim vendored copy of
 * `packages/client/ui-settings-plugins/src/client/card-form.ts` (the built-in
 * `CardForm`, packaged separately because a third-party plugin cannot import
 * the internal ui-settings-plugins package).
 *
 ...
 * presence, not a value comparison, is what marks a field overridden.
 */
